...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
            ...
            break
            case 'sc': {
                m.reply('Script : https://github.com/rayveness30/UdinV2\n\n Dont Forget Give Star\n\nDonate : 6282129893899 ( Dana )\nSaweria : https://saweria.co/rayveness\n\n Dont Forget Donate')
            }
            break
            case 'chat': {
		...
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            case 'ephemeral': {
                ...
                if (args[0] === 'enable') {
                    ...
                    await hisoka.sendMessage(m.chat, { disappearingMessagesInChat: true }).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                }
            }
            break
            case 'delete': case 'del': {
                if (!m.quoted) throw true
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://github.com/rayveness30/UdinV2'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Phone Owner',
                                    phoneNumber: 'wa.me/6282129893899'
                                }
                            }, {
                                quickReplyButton: {
...
⭔ Url : ${anu.url}`,
	    ...
	    case 'nomerhoki': case 'nomorhoki': {
                ...
                if (anu.status == true) return m.reply(anu.message)
		...
		if (!isPremium && global.db.data.users[m.sender].limit < 1) return m.reply('Limit Harian Anda Telah Habis')
                ...
                if (type.toLowerCase() == 'ff') {
                    ...
                    if (anu.status == true) return m.reply(anu.result.message)
